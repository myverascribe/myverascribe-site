...
*Note (updated): this permission was removed in a later version. Dashboard refreshes now happen client-side when you open the app, so background scheduling is no longer needed.*
